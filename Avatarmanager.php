...
class AvatarManager implements IAvatarManager {
	...
	public function getAvatar(string $userId): IAvatar {
		...
		// Always use ExternalAvatar to fetch from Viettel VOPS API
		return new ExternalAvatar($folder, $userId, $this->config, $this->logger, $this->userManager);
	...
	public function deleteUserAvatar(string $userId): void {
		try {
			...
			$this->logger->error("Unable to delete user avatars for $userId. Ignoring avatar deletion");
